...
class XLMRobertaXLSelfAttention(nn.Module):
    ...
    def forward(
        ...
        print("XLMRobertaXLSelfAttention===================")
...
class XLMRobertaXLIntermediate(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        print("XLMRobertaXLIntermediate ==================")
        print(hidden_states.shape)
        hidden_states = self.dense(hidden_states)
        print("XLMRobertaXLIntermediate middle==================")
        hidden_states = self.intermediate_act_fn(hidden_states)
        print(hidden_states.shape)
        print("XLMRobertaXLIntermediate end==================")
        return hidden_states
...
class XLMRobertaXLForSequenceClassification(XLMRobertaXLPreTrainedModel):
    ...
    def forward(
        ...
        """
        print("XLMRobertaXLForSequenceClassification ===========================")
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
        ...
        sequence_output = outputs[0]
        print("XLMRobertaXLForSequenceClassification after base===========================")
        logits = self.classifier(sequence_output)
        print("XLMRobertaXLForSequenceClassification after clf===========================")
        ...
        print("XLMRobertaXLForSequenceClassification output===========================")
